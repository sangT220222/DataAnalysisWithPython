...
def calculate_demographic_data(print_data=True):
    ...
    earning_above = df[df['salary'] == '>50K']
    highest_earning_country = earning_above['native-country'].value_counts().idxmax()

    highest_earning_country_percentage = (df[df['native-country'] == highest_earning_country]['salary'] == '>50K').mean() * 100

    # Identify the most popular occupation for those who earn >50K in India.
    ##filter datafram to be india
    india_df = df[df['native-country'] == 'India']
    ##filter to those earning above 50K
    rich_indian = india_df[india_df['salary'] == '>50K']
